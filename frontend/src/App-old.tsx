        ...
        <div className="flex justify-between">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              MongoDB-powered credit management system with blockchain
              integration
            </p>
          </div>
          <div className="flex">
        ...
        <div className="card">
          ...
          <div
            className={`p-4 rounded-lg ${
              dbStatus.success ? "bg-green-50" : "bg-red-50"
            }`}
          >
            <div className="flex">
              {dbStatus.success ? (
              ...
              <div className="ml-2">
                ...
                <p
                  className={`text-sm ${
                    dbStatus.success ? "text-green-700" : "text-red-700"
                  }`}
                >
                ...
                {dbStatus.testUser && (
                  <div className="mt-2 text-sm text-green-700">
                    <p>
                      <strong>User ID:</strong> {dbStatus.testUser.id}
                    </p>
                    <p>
                      <strong>Email:</strong> {dbStatus.testUser.email}
                    </p>
                    <p>
                      <strong>Credits:</strong> {dbStatus.testUser.credits}
                    </p>
                  </div>
                )}
              </div>
